...
attr_reader :age was added to the class. This is a reader, which means it returns a value outside the class, but does not change it.

What was replaced?
Instead of creating a method for age called what_is_age, we don't need that code anymore since we just made the symbol :age a reader method.

Is this code simpler than the last?
Much simper - you can remove an entire method definition and still be able to call the method.
